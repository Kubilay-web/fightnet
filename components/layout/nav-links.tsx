  ...
  return (
    <>
      <button
        ...
        className="inline-flex size-10 items-center justify-center rounded-xl text-ink-500 transition-colors hover:bg-ink-100 dark:text-ink-400 dark:hover:bg-ink-800 lg:hidden"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          />
          <div className="absolute inset-y-0 left-0 flex w-[82%] max-w-xs flex-col border-r border-[var(--border)] bg-[var(--bg)] animate-[slide-up_0.2s_cubic-bezier(0.16,1,0.3,1)]">
